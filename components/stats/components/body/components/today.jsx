...
export default function Today({ datas, item, month }) {
  return (
    <View style={{ marginTop: 15 }}>
      <View style={styles.firstrow}>
        <View style={styles.first1}>
          ...
          <NumberFormat
            value={month[0][1].total_cases - month[1][1].total_cases}
            displayType={"text"}
        ...
        <View style={styles.first2}>
          ...
          <NumberFormat
            value={month[0][1].deaths - month[1][1].deaths}
            displayType={"text"}
            thousandSeparator={true}
            renderText={(value) => <Text style={styles.number}>{value}</Text>}
          />
      ...
      <View style={styles.secondrow}>
        <View style={styles.second1}>
          ...
          <NumberFormat
            value={month[0][1].recovered - month[1][1].recovered}
            displayType={"text"}
            thousandSeparator={true}
        ...
        <View style={styles.second2}>
          ...
          <NumberFormat
            value={
              month[0][1].tested - month[1][1].tested < 0
                ? 0
                : month[0][1].tested - month[1][1].tested
            }
            displayType={"text"}
            thousandSeparator={true}
            renderText={(value) => <Text style={styles.number1}>{value}</Text>}
        ...
        <View style={styles.second3}>
          ...
          <NumberFormat
            value={
              month[0][1].critical - month[1][1].critical < 0
                ? 0
                : month[0][1].critical - month[1][1].critical
            }
            displayType={"text"}
            thousandSeparator={true}
            renderText={(value) => <Text style={styles.number1}>{value}</Text>}
